...
class ProviderStageSpec:
    ...
    def load(cls, path: Path) -> "ProviderStageSpec":
        ...
        ocr = ProviderStageOcrParams(
            ...
            qwen_base_url=str(
                ocr_payload.get("qwen_base_url", "https://dashscope.aliyuncs.com/compatible-mode/v1")
                or "https://dashscope.aliyuncs.com/compatible-mode/v1"
            ),
            qwen_model=str(ocr_payload.get("qwen_model", "qwen3.5-ocr") or "qwen3.5-ocr"),
            qwen_workers=int(ocr_payload.get("qwen_workers", 3) or 3),
